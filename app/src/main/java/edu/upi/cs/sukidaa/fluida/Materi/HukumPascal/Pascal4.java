...
public class Pascal4 extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        videoView1 = (CustomVideoView) rootView.findViewById(R.id.pascal4vv1);
        play1 = (ImageView) rootView.findViewById(R.id.playpascal4);

        TextView pascal41 = (TextView) rootView.findViewById(R.id.pascal4tv1);

        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            pascal41.setText(Html.fromHtml(getString(R.string.pascal41), Html.FROM_HTML_MODE_COMPACT));
        }else{
            pascal41.setText(Html.fromHtml(getString(R.string.pascal41)));
        }

        MediaController mediaController = new MediaController(getActivity());
        videoView1.setVideoURI(Uri.parse("android.resource://" +  getActivity().getPackageName() + "/" + R.raw.pascal4v1));
