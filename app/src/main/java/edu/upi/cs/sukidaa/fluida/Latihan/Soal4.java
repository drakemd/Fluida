...
public class Soal4 extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            soal.setText(Html.fromHtml(getString(R.string.soal4), Html.FROM_HTML_MODE_COMPACT));
        }else{
            soal.setText(Html.fromHtml(getString(R.string.soal4)));
        }
    ...
    public void onClick(View v) {
        ((Soal)getActivity()).selectButton(R.id.btnNo4);
        switch (v.getId()){
            case R.id.buttonA:
