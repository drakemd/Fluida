...
public class Pascal1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        videoView1 = (CustomVideoView) rootView.findViewById(R.id.pascal1vv1);
        play1 = (ImageView) rootView.findViewById(R.id.play);

        MediaController mediaController = new MediaController(getActivity());
        videoView1.setVideoURI(Uri.parse("android.resource://" +  getActivity().getPackageName() + "/" + R.raw.pascalvid1));
    ...
    public void onDetach() {
        super.onDetach();
        videoView1.destroyDrawingCache();
    }
}
