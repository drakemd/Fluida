...
public class Soal7 extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            btnA.setText(Html.fromHtml(getString(R.string.soal7a), Html.FROM_HTML_MODE_COMPACT));
            btnB.setText(Html.fromHtml(getString(R.string.soal7b), Html.FROM_HTML_MODE_COMPACT));
            btnC.setText(Html.fromHtml(getString(R.string.soal7c), Html.FROM_HTML_MODE_COMPACT));
            btnD.setText(Html.fromHtml(getString(R.string.soal7d), Html.FROM_HTML_MODE_COMPACT));
        }else{
            btnA.setText(Html.fromHtml(getString(R.string.soal7a)));
            btnB.setText(Html.fromHtml(getString(R.string.soal7b)));
            btnC.setText(Html.fromHtml(getString(R.string.soal7c)));
            btnD.setText(Html.fromHtml(getString(R.string.soal7d)));
        }
    ...
    public void onClick(View v) {
        ((Soal)getActivity()).selectButton(R.id.btnNo7);
        switch (v.getId()){
            case R.id.buttonA:
