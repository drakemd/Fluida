...
public class Soal5 extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            soal.setText(Html.fromHtml(getString(R.string.soal5), Html.FROM_HTML_MODE_COMPACT));
            btnA.setText(Html.fromHtml(getString(R.string.soal5a), Html.FROM_HTML_MODE_COMPACT));
            btnB.setText(Html.fromHtml(getString(R.string.soal5b), Html.FROM_HTML_MODE_COMPACT));
            btnC.setText(Html.fromHtml(getString(R.string.soal5c), Html.FROM_HTML_MODE_COMPACT));
            btnD.setText(Html.fromHtml(getString(R.string.soal5d), Html.FROM_HTML_MODE_COMPACT));
        }else{
            soal.setText(Html.fromHtml(getString(R.string.soal5)));
            btnA.setText(Html.fromHtml(getString(R.string.soal5a)));
            btnB.setText(Html.fromHtml(getString(R.string.soal5b)));
            btnC.setText(Html.fromHtml(getString(R.string.soal5c)));
            btnD.setText(Html.fromHtml(getString(R.string.soal5d)));
        }
    ...
    public void onClick(View v) {
        ((Soal)getActivity()).selectButton(R.id.btnNo5);
        switch (v.getId()){
            case R.id.buttonA:
