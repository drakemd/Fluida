...
public class AplPascal3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(
                R.layout.aplipascal3
                , container,false);

        videoView1 = (CustomVideoView) rootView.findViewById(R.id.apl3vv1);
        play1 = (ImageView) rootView.findViewById(R.id.apl3play);

        MediaController mediaController = new MediaController(getActivity());
        videoView1.setVideoURI(Uri.parse("android.resource://" +  getActivity().getPackageName() + "/" + R.raw.apl3v1));
