...
public class Pascal5 extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(
                R.layout.pascal5, container, false);
        ...
        imgSol1 = (ImageView) rootView.findViewById(R.id.pascalsol1);
        imgSol2 = (ImageView) rootView.findViewById(R.id.pascalsol2);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.buttonC :
                ...
                break;
            case R.id.buttonD :
                btnD.setBackgroundResource(R.drawable.btncorrect);
